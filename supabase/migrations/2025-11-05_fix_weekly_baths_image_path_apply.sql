-- =============================================
-- MIGRAÇÃO: Aplicar ajuste de image_path e função de integração
-- =============================================

-- 1) Adicionar coluna image_path em weekly_baths (idempotente)
ALTER TABLE public.weekly_baths
ADD COLUMN IF NOT EXISTS image_path TEXT;

-- 2) Backfill image_path a partir de image_url pública
...
-- 3) Atualizar função create_journey_event_from_bath para usar file_path baseado em image_path
